...
const hitungCKD = (data) => {
    ...
    // IMT tetap dihitung untuk direkam ke database, meskipun tidak dipakai untuk koreksi kalori di CKD
    const dataIMT = hitungIMT(berat_badan, tinggi_badan); 

    // 2. KEBUTUHAN ENERGI TOTAL (TEE) KHUSUS CKD
    // Rumus: Umur < 60 = 35 * BBI | Umur >= 60 = 30 * BBI
    ...
    // Tetap dipertahankan jika ada kasus ibu hamil dengan riwayat ginjal
    ...
    return {
        ...
        // KELOMPOK 1: KOREKSI (Semua 0 karena CKD tidak pakai sistem koreksi basal)
        koreksi: {
            energi_basal: 0,
            koreksi_umur: 0,
            koreksi_aktivitas: 0,
        ...
        data_simpan: {
            berat_badan_ideal: parseFloat(bbi.toFixed(2)),
            bmr: 0, // Sengaja dinolkan sesuai konsep CKD
