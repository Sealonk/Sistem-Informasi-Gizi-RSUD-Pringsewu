...
const hitungCHF = (data) => {
    ...
    // Kita buat pengecekan jika frontend mengirim angka langsung (misal "1.4")
    ...
    return {
        ...
        // KELOMPOK 1: KOREKSI 
        // Mengirimkan angka pengali (multiplier) ke frontend sebagai info
        koreksi: {
            energi_basal: parseFloat(bmr.toFixed(2)),
            koreksi_umur: 0, // Di-handle di dalam BMR Mifflin
            koreksi_aktivitas: parseFloat(faktorAktivitas.toFixed(2)),
            koreksi_berat_badan: 0, // Di-handle karena langsung pakai BBI
        ...
        data_simpan: {
            ...
            faktor_aktivitas_nilai: parseFloat(faktorAktivitas.toFixed(2)), // Aman disimpan ke DB
            faktor_stres_nilai: parseFloat(faktorStres.toFixed(2)),         // Aman disimpan ke DB
