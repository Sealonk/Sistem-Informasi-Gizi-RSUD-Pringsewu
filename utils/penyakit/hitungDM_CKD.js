// ==========================================
// UTILS/PENYAKIT: hitungDM_CKD.js
// ==========================================
...
const hitungDM_CKD = (data) => {
    const { 
        ...
        status_hemodialisa // Tambahan parameter krusial untuk CKD
    } = data;
    ...
    // =========================================================================
    // 9. DISTRIBUSI MAKRONUTRIEN (DM + CKD)
    // PERBEDAAN UTAMA: Protein bergantung pada Hemodialisa (Excel: IF($H$14=1;0.8*BBI;1.2*BBI))
    // =========================================================================
    
    // Hitung Protein (CKD Logic)
    let protein_gram = 0;
    ...
    // Hitung Lemak (Sama dengan DM: 25% dari TEE)
